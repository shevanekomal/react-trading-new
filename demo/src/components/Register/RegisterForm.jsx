      ...
      {width> 990 && <div className='Header'>Register</div>}
        <FormRow
          ...
          <FormRow
            ...
            changeHandler={(e)=>onChangehandler(e)}
          />
          <p><CheckboxesGroup name='loginWithOtp'  onChange={(e)=>onChangehandler(e)} options={[ {text:'By signing up, I agree to the terms',name:'true'}]} /></p>
          <button onClick={(e)=>{
            e.preventDefault()
            isValidate && setNextPageEnable(true)
          }} className={isValidate?'customButton activeButtonStyle':'customButton'}>GET OTP</button>
